...
CREATE TABLE `matricula` (
  ...
  KEY `fk_matricula_cursos1_idx` (`cursos_idcursos`),
  CONSTRAINT `fk_matricula_alumno` FOREIGN KEY (`alumno_codigo_alumno`) REFERENCES `alumno` (`codigo_alumno`),
  CONSTRAINT `fk_matricula_cursos1` FOREIGN KEY (`cursos_idcursos`) REFERENCES `cursos` (`idcurso`)
